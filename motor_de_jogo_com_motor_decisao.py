...
def continuar_rodada(maos, tabuleiro, pontas, jogador_inicial, historico_inicial=None, ordem_jogada_inicial=1):
    tabuleiro = deque(tabuleiro)
    pontas = pontas[:]
    historico = historico_inicial[:] if historico_inicial else []
    estados = []
    ordem_jogada = ordem_jogada_inicial
...
def simular_rodada():
    ...
    return continuar_rodada(maos, tabuleiro, pontas, proximo_jogador(jogador), historico_inicial=historico, ordem_jogada_inicial=2)